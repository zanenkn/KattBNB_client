        ...
        <div style={{ 'margin': '-2rem -2rem 2rem', 'background': '#c90c61', 'padding': '2rem' }}>
          ...
          <p style={{ 'color': '#ffffff', 'fontSize': 'small' }}>
            <Trans i18nKey='IncRequestDeclinedPopup:desc'>
              You declined a booking request from <strong>{{ nickname: props.nickname }}</strong> for the dates of <strong>{{ startDate: props.startDate }}</strong> until <strong>{{ endDate: props.endDate }}</strong>.
            </Trans>
          </p>
        </div>
