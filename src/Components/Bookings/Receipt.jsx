...
const Receipt = ({ history }) => {
  ...
  //           <p style={{ width: '75%' }}>{t('Receipt:service-fee')}</p>
  //           <p>{formatPrice(priceTotal * 0.17)} kr</p>
  //         </div>
  //         <div style={{ display: 'flex', justifyContent: 'space-between' }}>
  //           <p style={{ width: '75%' }}>{t('Receipt:vat')}</p>
  //           <p>{formatPrice(swedishVAT)} kr</p>
  //         </div>
  //         <Divider />
  //         <div style={{ display: 'flex', justifyContent: 'space-between' }}>
  //           <p style={{ width: '75%' }}>
  //             <strong style={{ color: '#c90c61' }}>{t('Receipt:total')}</strong>
  //           </p>
  //           <p>
  //             <strong style={{ color: '#c90c61' }}>{priceOfOneAmount(priceTotal)} kr</strong>
  //           </p>
  //         </div>
  //       </Segment>
  //     </div>
