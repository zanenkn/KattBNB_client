...
const SupplementUpdateForm = (props) => {
  ...
  if (ready) {
    return (
      <>
        <Divider />
        <p className='small-centered-paragraph'>{t('SupplementUpdateForm:main-title')}</p>
        ...
        <div className='button-wrapper'>
          <Button secondary id='supplement-close-button' className='cancel-button' onClick={props.closeAllForms}>
