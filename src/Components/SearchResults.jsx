...
class SearchResults extends Component {
  ...
  render() {
    ...
    listButton = (
      <Button id='list-button' onClick={() => { this.setState({ listResults: true }) }}>List</Button>
    )

    mapButton = (
      <Button id='map-button' onClick={() => { this.setState({ listResults: false }) }}>Map</Button>
    )
          ...
          <Grid className='list-header'>
            <Grid.Row columns='equal' style={{ 'padding': '0', 'marginBottom': '1rem', 'alignItems': 'baseline' }}>
              ...
              <Grid.Column width={4} style={{ 'padding': '0' }}>
                <p style={{ 'color': 'grey', 'textAlign': 'right', 'fontSize': 'small' }}>
