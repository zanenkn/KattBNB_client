...
const Navbar = (props) => {
  ...
  //         </button>
  //       </Grid.Column>
  //       <Grid.Column style={{ padding: '0', display: 'flex', flexDirection: 'row' }} width={12}>
  //         <Container
  //           className='navlink'
  //           as={Link}
  //           to='/search'
  ...
  //           }
  //         >
  //           <svg id='messenger-icon' className='icon' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 20 20'>
  //             <path
  //               fill='#FFFFFF'
  ...
  //           }
  //         >
  //           <svg id='bookings-icon' className='icon' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 20 20'>
  //             <path
  //               fill='#FFFFFF'
  ...
  //             ></Image>
  //           ) : (
  //             <svg id='user-icon' className='icon' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 20 20'>
  //               <path
  //                 fill='#FFFFFF'
