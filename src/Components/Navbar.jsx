          ...
          <Grid.Column style={{ 'padding': 0 }} width={12}>
            <Grid id='navlinks'>
              ...
              <Grid.Column width={4}>
                <Container 
                  className='navlink' 
                  as={Link} to={this.props.currentUserIn ? '/messenger' : '/login'} 
                  onClick={this.props.menuVisible ? () => { this.props.dispatch({ type: 'CHANGE_VISIBILITY' }) } : () => { }}>
              ...
              <Grid.Column width={4}>
                <Container 
                  className='navlink' 
                  as={Link} to={this.props.currentUserIn ? '/all-bookings' : '/login'} 
                  onClick={this.props.menuVisible ? () => { this.props.dispatch({ type: 'CHANGE_VISIBILITY' }) } : () => { }}>
              ...
              <Grid.Column width={4}>
                <Container 
                  className='navlink' 
                  as={Link} to={this.props.currentUserIn ? '/user-page' : '/login'}
                  onClick={this.props.menuVisible ? () => { this.props.dispatch({ type: 'CHANGE_VISIBILITY' }) } : () => { }}>
