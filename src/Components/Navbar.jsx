...
class Navbar extends Component {
  ...
  render() {
    let userIcon, bookingsIcon, messengerIcon, hamburgerIcon, noAvatar
    ...
    if (this.props.currentUserIn) {
      ...
      userIcon = (
        <Grid.Column className='navlink' width={4} as={Link} to='/user-page' onClick={this.props.menuVisible ? () => { this.props.dispatch({ type: 'CHANGE_VISIBILITY' }) } : () => { }}>
      ...
      messengerIcon = (
        <Grid.Column className='navlink' width={4} as={Link} to='/messenger' onClick={this.props.menuVisible ? () => { this.props.dispatch({ type: 'CHANGE_VISIBILITY' }) } : () => { }}>
