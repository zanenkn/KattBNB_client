...
const ImageUploadPopup = (props) => {
  ...
  //           background: '#eeeeee',
  //           borderRadius: '0',
  //           display: props.imageUploadButton ? 'block' : 'none',
  //         }}
  //         withLabel={false}
  //         withIcon={false}
  ...
  //             margin: '0',
  //             height: '2rem',
  //             display: props.uploadedImage === '' || props.loadingUploadButton ? 'none' : 'block',
  //           }}
  ...
  //           {t('ImageUploadPopup:file-size')}
  //           <br />
  //           {t('ImageUploadPopup:supported-formats')}
  //         </p>
  //       </div>
  //       <Button
