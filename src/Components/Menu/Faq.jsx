        ...
        <div className='expanding-wrapper'>
          ...
          <Accordion>
            ...
            <Accordion.Content active={activeIndex === 101}>
              <p>
                <Trans i18nKey='Faq:general.p1-1'>
                  Make sure you check your spam folder, sometimes the confirmation email can end up there. If that is
                  the case, please
                  <a
                    href='https://www.lifewire.com/how-to-whitelist-email-addresses-4588603'
                    target='_blank'
                    rel='noopener noreferrer'
                    className='fake-link-underlined-reg'
                  >
                    whitelist our address
                  </a>
                  (meow-reply@kattbnb.se) via your email client settings. That way, you will receive every notification
                  directly in your inbox.
                </Trans>
              </p>
              <p>{t('Faq:general.p1-2')}</p>
            </Accordion.Content>
            <Accordion.Title
            ...
            <Accordion.Content active={activeIndex === 103}>
              <p>{t('Faq:general.p3-1')}</p>
              <p>{t('Faq:general.p3-2')}</p>
              <ul>
                <li>{t('Faq:general.list-item3-2-1')}</li>
                <li>{t('Faq:general.list-item3-2-2')}</li>
              </ul>
              <p>{t('Faq:general.p3-3')}</p>
              <p>
                <Trans i18nKey='Faq:general.p3-4'>
                  Please don't hesitate to
                  <Header as={Link} to='contact-us' className='fake-link-underlined-reg'>
                    contact us
                  </Header>
                  ...
                </Trans>
            ...
            <Accordion.Content active={activeIndex === 104}>
              <p>{t('Faq:general.p4-1')}</p>
              <p>{t('Faq:general.p4-2')}</p>
              <p>{t('Faq:general.p4-3')}</p>
            </Accordion.Content>
            <Accordion.Title
            ...
            <Accordion.Content active={activeIndex === 106}>
              <p>
                <Trans i18nKey='Faq:general.p6-1'>
                  Our website does not use any cookies or other tracking mechanisms. You can read more about what data
                  we collect in our
                  <Header as={Link} to='legal' className='fake-link-underlined-reg'>
            ...
            <Accordion.Content active={activeIndex === 107}>
              <p>{t('Faq:general.p7-1')}</p>
              <p>{t('Faq:general.p7-2')}</p>
              <p>{t('Faq:general.p7-3')}</p>
            </Accordion.Content>
          </Accordion>
          ...
          <Accordion>
            ...
            <Accordion.Content active={activeIndex === 201}>
              <Link to={window.localStorage.getItem('I18N_LANGUAGE') === 'en' ? '/become-host' : '/bli-kattvakt'}>
                <p className='fake-link-underlined-reg' style={{ marginBottom: '1rem' }}>
                  {t('Faq:host.video-link')}
                </p>
              </Link>
              <p>{t('Faq:host.p1-1')}</p>
              {props.currentUserIn === false && (
                <a
                  href='https://www.kattbnb.se/sign-up'
                  target='_blank'
                  rel='noopener noreferrer'
                  style={{ display: 'contents', width: content }}
                >
                  <Button style={{ margin: '1rem auto 1rem' }}>{t('reusable:title.signup')}</Button>
                </a>
              )}
              <p>{t('Faq:host.p1-2')}</p>
              {props.currentUserIn && (
                <a
                  href='https://www.kattbnb.se/user-page'
                  target='_blank'
                  rel='noopener noreferrer'
                  style={{ display: 'contents', width: content }}
                >
                  <Button style={{ margin: '1rem auto 1rem' }}>{t('reusable:cta.make-host-profile')}</Button>
                </a>
              )}
              <p>{t('Faq:host.p1-3')}</p>
            </Accordion.Content>
            ...
            <Accordion.Content active={activeIndex === 203}>
              ...
              <Segment raised style={{ paddingTop: '1rem', marginBottom: '1rem' }}>
                ...
                <p style={{ padding: '0 1rem 1rem 1rem', textSize: 'small' }}>{t('reusable:explain-supplement')}</p>
              </Segment>
              <p>
                <Trans i18nKey='Faq:host.p3-2'>
                  You can
                  <a href='https://www.kattbnb.se/contact-us' target='_blank' rel='noopener noreferrer'>
                    contact us
                  </a>
                  if you would like an assistance with setting your rates.
                </Trans>
              </p>
            </Accordion.Content>
            <Accordion.Title
            ...
            <Accordion.Content active={activeIndex === 204}>
              ...
              <Segment raised style={{ paddingTop: '1rem' }}>
                ...
                <p style={{ padding: '0 1rem 1rem 1rem' }}>{t('Faq:host.list-item4-1')}</p>
              </Segment>
            </Accordion.Content>
            <Accordion.Title
          ...
          <Accordion>
            ...
            <Accordion.Content active={activeIndex === 301}>
              ...
              <p>{t('Faq:owner.p1-2')}</p>
              <p>{t('Faq:owner.p1-3')}</p>
            </Accordion.Content>
            <Accordion.Title
