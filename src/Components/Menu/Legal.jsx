    ...
    return (
      <>
        ...
        <div className='expanding-wrapper'>
          ...
          <Header as='h2'>{t('Legal:general.title')}</Header>
          ...
          <Header as='h2'>{t('Legal:booking.title')}</Header>
          ...
          <p>
            <Trans i18nKey='Legal:booking.p7'>
              It is Cat Sitter's own responsibility to declare any eventual income generated from fulfilling Services.
              If you take care for pets as a business activity you may be eligible for approval of Swedish F-tax.
              <a href='https://skatteverket.se/' target='_blank' rel='noopener noreferrer'>
                Please refer to Swedish Tax Agency for more information.
              </a>
            </Trans>
          </p>
          <p>
            <Trans i18nKey='Legal:booking.p8'>
              Cat Sitters who professionally care for cats may need a permit.
              <a
                href='https://www.riksdagen.se/sv/dokument-lagar/dokument/svensk-forfattningssamling/djurskyddslag-20181192_sfs-2018-1192'
                target='_blank'
                rel='noopener noreferrer'
              >
                Please refer to Swedish Animal Welfare Act chapter 6.1 for more information.
              </a>
              Users are themselves responsible to determine if they require permit to perform the Service and obtain
              such permit if necessary.
            </Trans>
          </p>
          <p>{t('Legal:booking.p9')}</p>
          <Header as='h2'>{t('Legal:during-service.title')}</Header>
            ...
            <ul>
              <li>
                <Trans i18nKey='Legal:during-service.li1'>
                  attending to Cat Owner's cat(s) at least twice a day according to
                  <a
                    href='https://www.riksdagen.se/sv/dokument-lagar/dokument/svensk-forfattningssamling/lag-20071150-om-tillsyn-over-hundar-och_sfs-2007-1150'
                    target='_blank'
                    rel='noopener noreferrer'
                  >
                    Swedish Law on the supervision of dogs and cats
                  </a>
                  ,
                </Trans>
              </li>
          ...
          <p>
            <Trans i18nKey='Legal:during-service.p3'>
              It is both Cat Owner's and Cat Sitter's responsibility to examine the cat(s) before Service commences and
              agree on relevant matters. Users can use
              <a href='https://kattbnb.se/guidelines' target='_blank' rel='noopener noreferrer'>
                KattBNB Guidelines
              </a>
          ...
          <Header as='h2'>{t('Legal:personal-data.title')}</Header>
          <Header as='h3' style={{ textAlign: 'left' }}>
          ...
          <p>
            <Trans i18nKey='Legal:personal-data.in-general.p5'>
              KattBNB is responsible to protect your personal data according to the
              <a
                href='https://www.riksdagen.se/sv/dokument-lagar/dokument/svensk-forfattningssamling/lag-2018218-med-kompletterande-bestammelser_sfs-2018-218'
                target='_blank'
                rel='noopener noreferrer'
              >
          ...
          <p>
            <Trans i18nKey='Legal:personal-data.in-detail.p9'>
              For a more detailed flow of what happens when Users request an account deletion, please refer to our
              <a href='https://kattbnb.se/faq' target='_blank' rel='noopener noreferrer'>
                FAQ page
              </a>
              .
            </Trans>
          </p>
          <Header as='h2'>{t('Legal:contact-us.title')}</Header>
          <p>
            <Trans i18nKey='Legal:contact-us.p1'>
              If you have any questions or suggestions about our Terms, do not hesitate to
              <a href='https://kattbnb.se/contact-us' target='_blank' rel='noopener noreferrer'>
                contact us
              </a>
              .
            </Trans>
