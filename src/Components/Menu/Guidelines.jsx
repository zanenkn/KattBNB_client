    ...
    return (
      <>
        <Helmet>
          ...
          <meta name='description' content='Har du hittat den perfekta kattvakt? Grattis! Här har du några viktiga saker att tänka på innan vistelsen.' />
          ...
          <meta property='og:description' content='Vi bryr oss om katterna. Här har vi samlat några viktiga saker du bör fundera på innan din vistelse hos kattvakten.' />
