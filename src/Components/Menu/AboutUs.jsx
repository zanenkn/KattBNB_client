    ...
    return (
      <>
        ...
        <div className='expanding-wrapper' style={{ paddingTop: '0' }}>
          <Header as='h2'>{t('AboutUs:idea-title')}</Header>
          <p>{t('AboutUs:idea-p1')}</p>
          <p>{t('AboutUs:idea-p2')}</p>
          <p>{t('AboutUs:idea-p3')}</p>
          <Divider hidden />
          <Divider hidden />
          <Header as='h2'>{t('AboutUs:behind-scenes-title')}</Header>
          <div>
            <Image style={{ margin: 'auto' }} src='zane2.png' size='small'></Image>
          </div>
          <Header style={{ marginBottom: 0 }}>
            <a href='https://www.linkedin.com/in/zane-neikena' target='_blank' rel='noopener noreferrer'>
              Zane Neikena
            </a>
          </Header>
          ...
          <p style={{ textAlign: 'center' }}>{t('AboutUs:zane-txt')}</p>
          <Divider hidden />
          <Divider hidden />
          <div>
          ...
          <Header style={{ marginBottom: 0 }}>
            <a href='https://www.linkedin.com/in/george-tomaras-05833730/' target='_blank' rel='noopener noreferrer'>
              George Tomaras
            </a>
          </Header>
          <Header as='h4' style={{ marginTop: 0 }}>
          ...
          <p style={{ textAlign: 'center' }}>{t('AboutUs:george-txt')}</p>
          <Divider hidden />
          <Divider hidden />
          <div>
          ...
          <Header style={{ marginBottom: 0 }}>
            <a href='https://www.linkedin.com/in/realelaura/' target='_blank' rel='noopener noreferrer'>
              Laura Reale
            </a>
          </Header>
          <Header as='h4' style={{ marginTop: 0 }}>
          ...
          <p style={{ textAlign: 'center' }}>{t('AboutUs:laura-txt')}</p>
          <Divider hidden />
          <Divider hidden />
          <div>
          ...
          <Header style={{ marginBottom: 0 }}>
            <a href='https://www.linkedin.com/in/joel-%C3%B6hman-b09307159/' target='_blank' rel='noopener noreferrer'>
              Joel Öhman
            </a>
          </Header>
          <Header as='h4' style={{ marginTop: 0 }}>
          ...
          <p style={{ textAlign: 'center' }}>{t('AboutUs:joel-txt')}</p>
          <Divider hidden />
          <Divider hidden />
          <Header as='h2'>{t('AboutUs:acknowledgements-title')}</Header>
          <p>
            <Trans i18nKey='AboutUs:acknowledgements-felix'>
              ...
              for all the encouragement, advice in business development and the invaluable help with our very first
              pitch deck.
            </Trans>
          </p>
          <Divider hidden />
          <p>
            <Trans i18nKey='AboutUs:acknowledgements-clarissa'>
              ...
              for introducing us with i18n solution for translations and helping out with the setup, best of luck with
              you career as a developer!
            </Trans>
          </p>
        </div>
