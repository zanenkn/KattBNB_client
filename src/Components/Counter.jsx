...
const Counter = (props) => {
      ...
      return (
        ...
        >
          <Helmet>
            ...
            <meta
              name='description'
              content='Vi bryr oss om katterna. På KattBNB kommer du kunna boka kattvakt online - snabbt och enkelt! Registrera ditt konto idag.'
            />
            ...
            <meta
              ...
              content='På KattBNB kommer du kunna boka kattvakt online - snabbt och enkelt! Registrera ditt konto idag.'
            />
          ...
          <div className='content-wrapper' style={{ marginTop: '3rem', paddingTop: '0' }}>
            <table style={{ textAlign: 'center', margin: 'auto', color: '#3f3840' }}>
              <tr style={{ fontSize: '2rem', lineHeight: '1' }}>
                <td style={{}}>
                  <strong>{zeroPad(days)}</strong>
                </td>
                <td style={{ minWidth: '10px' }}>
                  <strong>:</strong>
                </td>
                <td style={{}}>
                  <strong>{zeroPad(hours)}</strong>
                </td>
                <td style={{ minWidth: '10px' }}>
                  <strong>:</strong>
                </td>
                <td style={{}}>
                  <strong>{zeroPad(minutes)}</strong>
                </td>
                <td style={{ minWidth: '10px' }}>
                  <strong>:</strong>
                </td>
                <td style={{}}>
                  <strong>{zeroPad(seconds)}</strong>
                </td>
              </tr>
            ...
            <div>
              <p style={{ marginTop: '2rem', color: '#3f3840', textAlign: 'center', maxWidth: '312px' }}>
                <Trans i18nKey='Counter:p'>
                  Hey there! We open for bookings the 1st of June but you can
                  <Link to='/sign-up' style={{ fontWeight: 'bold' }}>
                    sign up
                  </Link>
                  already now. Or maybe you want to
                  <Link
            ...
            style={{
              ...
              bottom:
                window.innerHeight < 540
                  ? '-42%'
                  : window.innerWidth > 320 && window.innerWidth < 500
                  ? '-15%'
                  : window.innerWidth > 500
                  ? '-80px'
                  : '-18%',
              maxWidth: window.innerWidth > 500 ? '500px' : `${window.innerWidth}px`,
            }}
          />
        </div>
      );
  ...
  return <Countdown date={'2020-06-01T07:00:00'} start renderer={renderer} />;
};
