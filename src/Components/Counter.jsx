    ...
    if (completed) {
      ...
      return (
        <div className='content-wrapper' style={{ 'margin': '0', 'backgroundColor': '#E0E0E0', 'position': 'fixed', 'height': '90vh', 'width': '100vw', 'display': 'flex', 'flexDirection': 'column', 'alignItems': 'center' }}>
          ...
          <img src='cat.gif' alt='' style={{ 'position': 'absolute', 'zIndex': '3500', 'bottom': (window.innerWidth > 320 && window.innerWidth < 500) ? '-15%' : window.innerWidth > 500 ? '-50px' : '-18%', 'maxWidth': window.innerWidth > 500 ? '500px' : `${window.innerWidth}px` }} />
        </div>
      )
    }
  }
