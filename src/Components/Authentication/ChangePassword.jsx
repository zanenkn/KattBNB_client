      ...
      return (
        <div className='content-wrapper' >
          ...
          <Segment className='whitebox'>
            ...
            {errorDisplay}
            {successDisplay}
            <Button className='submit-button' id='change-pass-button' disabled={this.state.loading} loading={this.state.loading ? true : false} onClick={this.changePassword}>{t('ChangePassword:title')}</Button>
          </Segment>
        </div>
      )
    } else { return <Spinner /> }
