      ...
      return (
        <>
          ...
          <div className='button-wrapper'>
            ...
            <Button id='location-submit-button' className='submit-button' disabled={this.state.loading} loading={this.state.loading ? true : false} onClick={this.updateLocation}>{t('reusable:cta.change')}</Button>
          </div>
