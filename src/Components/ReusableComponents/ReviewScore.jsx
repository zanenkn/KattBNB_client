...
const ReviewScore = (props) => {
  ...
  return (
    <div style={{ 'display': 'flex' }}>
      <div id="1" onClick={props.setScore}>
        <svg fill={props.activeScore >= 1 ? '#c90c61' : 'silver'} height='2em' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 390.1 390.1">
      ...
      <div id="2" onClick={props.setScore}>
        <svg fill={props.activeScore >= 2 ? '#c90c61' : 'silver'} height='2em' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 390.1 390.1">
          <path d="M132.6,177.9c31.2,0,56.5-34,56.5-75.8c0-41.8-25.3-75.8-56.5-75.8c-31.2,0-56.5,34-56.5,75.8
            C76.1,143.8,101.5,177.9,132.6,177.9z"/>
          <path d="M300.2,251.6c-1.2-1.6-2.3-3.1-2.9-4.3c-12.6-27-47.3-58.9-103.4-59.7l-2.2,0c-55.2,0-89.6,30.2-103.4,58.5
            c-0.5,1-1.5,2.2-2.6,3.5c-1.3,1.6-2.6,3.1-3.7,4.9c-11.6,18.1-17.5,38.4-16.7,57.3c0.9,20,9.3,36.1,23.6,45.3
      ...
      <div id="3" onClick={props.setScore}>
        <svg fill={props.activeScore >= 3 ? '#c90c61' : 'silver'} height='2em' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 390.1 390.1">
          <path d="M132.6,177.9c31.2,0,56.5-34,56.5-75.8c0-41.8-25.3-75.8-56.5-75.8c-31.2,0-56.5,34-56.5,75.8
            C76.1,143.8,101.5,177.9,132.6,177.9z"/>
          <path d="M300.2,251.6c-1.2-1.6-2.3-3.1-2.9-4.3c-12.6-27-47.3-58.9-103.4-59.7l-2.2,0c-55.2,0-89.6,30.2-103.4,58.5
            c-0.5,1-1.5,2.2-2.6,3.5c-1.3,1.6-2.6,3.1-3.7,4.9c-11.6,18.1-17.5,38.4-16.7,57.3c0.9,20,9.3,36.1,23.6,45.3
      ...
      <div id="4" onClick={props.setScore}>
        <svg fill={props.activeScore >= 4 ? '#c90c61' : 'silver'} height='2em' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 390.1 390.1">
          <path d="M132.6,177.9c31.2,0,56.5-34,56.5-75.8c0-41.8-25.3-75.8-56.5-75.8c-31.2,0-56.5,34-56.5,75.8
            C76.1,143.8,101.5,177.9,132.6,177.9z"/>
          <path d="M300.2,251.6c-1.2-1.6-2.3-3.1-2.9-4.3c-12.6-27-47.3-58.9-103.4-59.7l-2.2,0c-55.2,0-89.6,30.2-103.4,58.5
            c-0.5,1-1.5,2.2-2.6,3.5c-1.3,1.6-2.6,3.1-3.7,4.9c-11.6,18.1-17.5,38.4-16.7,57.3c0.9,20,9.3,36.1,23.6,45.3
      ...
      <div id="5" onClick={props.setScore}>
        <svg fill={props.activeScore >= 5 ? '#c90c61' : 'silver'} height='2em' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 390.1 390.1">
          <path d="M132.6,177.9c31.2,0,56.5-34,56.5-75.8c0-41.8-25.3-75.8-56.5-75.8c-31.2,0-56.5,34-56.5,75.8
            C76.1,143.8,101.5,177.9,132.6,177.9z"/>
          <path d="M300.2,251.6c-1.2-1.6-2.3-3.1-2.9-4.3c-12.6-27-47.3-58.9-103.4-59.7l-2.2,0c-55.2,0-89.6,30.2-103.4,58.5
            c-0.5,1-1.5,2.2-2.6,3.5c-1.3,1.6-2.6,3.1-3.7,4.9c-11.6,18.1-17.5,38.4-16.7,57.3c0.9,20,9.3,36.1,23.6,45.3
