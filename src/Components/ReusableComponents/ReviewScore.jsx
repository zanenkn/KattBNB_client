    ...
    >
      {score.map((sc) => {
        if (props.score % 1 !== 0 && Math.floor(props.score) + 1 === sc) {
          return (
            <div
              onClick={props.setScore}
              key={sc}
              id={sc}
              style={{ marginRight: '0.5rem', cursor: props.clickable ? 'pointer' : 'unset' }}
            >
              <svg xmlns='http://www.w3.org/2000/svg' height={props.height || '2em'} viewBox='0 0 25 25'>
                ...
                <path
                  fill='#C90C61'
                  d='M5.7,12.7c0-2.1-1.3-3.8-2.9-3.8C1.2,8.9,0,10.6,0,12.7s1.3,3.8,2.9,3.8S5.7,14.8,5.7,12.7z'
                />
                <path
                  fill='#C0C0C0'
          ...
          return (
            ...
            >
              <svg
                fill={Math.floor(props.score) >= sc ? '#c90c61' : 'silver'}
                height={props.height || '2em'}
                xmlns='http://www.w3.org/2000/svg'
                viewBox='0 0 390.1 390.1'
              >
                <path
                  d='M132.6,177.9c31.2,0,56.5-34,56.5-75.8c0-41.8-25.3-75.8-56.5-75.8c-31.2,0-56.5,34-56.5,75.8
                C76.1,143.8,101.5,177.9,132.6,177.9z'
                />
                <path
                  d='M300.2,251.6c-1.2-1.6-2.3-3.1-2.9-4.3c-12.6-27-47.3-58.9-103.4-59.7l-2.2,0c-55.2,0-89.6,30.2-103.4,58.5
                ...
                />
                <path
                  d='M252.8,177.9c31.1,0,56.5-34,56.5-75.8c0-41.8-25.4-75.8-56.5-75.8c-31.2,0-56.5,34-56.5,75.8
                C196.3,143.8,221.6,177.9,252.8,177.9z'
                />
                <path
                  d='M345.6,138.9c-25,0-44.5,25.9-44.5,59c0,33.1,19.6,59,44.5,59c25,0,44.5-25.9,44.5-59
